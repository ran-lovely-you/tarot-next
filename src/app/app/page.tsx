...
export default function AppPage() {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      if (!data?.access_active) { location.href = '/pricing'; return }
  ...
  const planLabel = access?.access_type === 'subscription' ? 'サブスク月額' : '買い切り'
  ...
  return (
    <>
      <div style={{
        ...
        <span style={{ fontFamily: "'Cinzel Decorative', serif", color: '#d4af37', fontSize: 15, letterSpacing: '0.08em' }}>
          ✦ タロット占い 天星鑑定
        </span>
